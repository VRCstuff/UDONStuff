...
namespace com.vrcstuff.udon
{
    ...
    public class ControllerTracker : UdonSharpBehaviour
    {
        ...
        [FormerlySerializedAs("VELOCITY_END_OFFSET")] [Tooltip("Offset from the most current frame (currentIndex) to use as the end point for velocity calculation. 0 means the current frame.")] [SerializeField, Range(0, 5)] // Added a range for the inspector, though it's a const here.
